  ...
  return (
    <div className={`not-prose my-8 mx-auto overflow-hidden shadow-lg border border-gray-200 dark:border-slate-700 ${isDesktop
      ...
      <div className="bg-gray-100 dark:bg-slate-800 px-4 py-3 flex items-center gap-2 border-t border-gray-200 dark:border-slate-700">
        {isDesktop && (
          <div aria-hidden="true" className="w-7 h-7 rounded-full bg-gray-200 dark:bg-slate-600 flex items-center justify-center flex-shrink-0">
        ...
        <div aria-hidden="true" className="w-7 h-7 rounded-full bg-blue-500 flex items-center justify-center flex-shrink-0">
